...
public interface PlayerController {
  ...
  @Operation(
      ...
      responses = {
          @ApiResponse(
              responseCode = "200", 
              description = "A Player was created", 
              content = @Content(mediaType = "application/json", 
              schema = @Schema(implementation = Player.class))),
          @ApiResponse(
              responseCode = "400", 
          ...
          @ApiResponse(
              responseCode = "404", 
              description = "A Player was unable to be created with the input criteria", 
              content = @Content(mediaType = "application/json")),
          @ApiResponse(
              responseCode = "500", 
              description = "An unplanned error occured", 
  ...
  // @formatter:off
  @Operation(
      summary = "Modifies a Player",
      description = "Modifies a Player",
      responses = {
          @ApiResponse(
              responseCode = "200", 
              description = "A Player was modified", 
              content = @Content(mediaType = "application/json", 
              schema = @Schema(implementation = Player.class))),
          @ApiResponse(
              responseCode = "400", 
          ...
          @ApiResponse(
              responseCode = "404", 
              description = "No Player was able to be modified with the input criteria", 
              content = @Content(mediaType = "application/json")),
          @ApiResponse(
              responseCode = "500", 
              description = "An unplanned error occured", 
  ...
  @Operation(
      ...
      responses = {
          @ApiResponse(
              responseCode = "200", 
              description = "A Player was deleted", 
              content = @Content(mediaType = "application/json", 
              schema = @Schema(implementation = Player.class))),
          @ApiResponse(
              responseCode = "400", 
          ...
          @ApiResponse(
              responseCode = "404", 
              description = "No Player was able to be deleted with the input criteria", 
              content = @Content(mediaType = "application/json")),
          @ApiResponse(
              responseCode = "500", 
              description = "An unplanned error occured", 
